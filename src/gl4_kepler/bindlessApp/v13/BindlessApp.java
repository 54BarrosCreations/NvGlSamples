 ...
 */
package gl4_kepler.bindlessApp.v13;
...
public class BindlessApp extends NvSampleApp {
    ...
    public void initRendering(GL4 gl4) {
        ...
        shader = NvGLSLProgram.createFromFiles(gl4, "src/gl4_kepler/bindlessApp/v13/shaders", "v13");
    ...
    private void initBuffers(GL4 gl4) {
        ...
        System.out.println(""+perMeshBufferName.toString());
...
//                }
//                gl4.glBindBuffer(GL_UNIFORM_BUFFER, 0);
                gl4.glBindBufferBase(GL_UNIFORM_BUFFER, Semantic.Uniform.PER_MESH, perMeshBufferName.get(i));
            }
